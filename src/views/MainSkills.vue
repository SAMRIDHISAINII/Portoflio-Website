    ...
    <div>
      <div>
        ...
        <p class="lg:text-lg text-sm text-justify leading-6">
          &nbsp;&nbsp;&nbsp;&nbsp; Samridhi is a full-stacked developer focused on
          <strong> MERN </strong>. She also possess soft skills
          to further enhance herself as a web developer with skills such as
