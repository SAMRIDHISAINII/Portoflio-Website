  ...
  <div>
    ...
    <section class="pt-5">
      <p class="lg:text-lg text-sm text-justify leading-6">
        ...
        <strong>samridhisaini01971@gmail.com</strong>. I will be able to reply to your
    ...
    <section class="">
      <p class="lg:text-lg text-sm text-justify leading-6">
        ...
        <strong class="underline"
          ><a href="https://github.com/SAMRIDHISAINII">Github Profile</a></strong
        >
	or
	<strong class="underline"
          ><a href="https://www.linkedin.com/in/samridhi-saini-b358841a6/">Linkedin Profile</a></strong
        >
